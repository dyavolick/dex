...
declare var Web3: any;
export function getClient(): Web3 {
  if (typeof web3 === "undefined") {
    return null;
  }
  var client = new Web3(web3.currentProvider);
  return client as Web3;
}
...
export interface Web3 {
  ...
  version: {
    getNetwork: (callback?: (error: string, netId: string) => void) => Promise<string>;
  };
...
export interface WebsocketProvider extends IProvider {
...
export interface HttpProvider extends IProvider {
...
export interface IpcProvider extends IProvider {
  responseCallbacks: undefined
  notificationCallbacks: undefined
  connection: undefined
  addDefaultEvents: undefined
...
export interface Utils {
  BN: any // TODO only static-definition
  isBN(any): boolean
...
export declare class Personal {
  ...
  lockAccount()
  unlockAccount()
  sign(hexMessage: string, address: string, callback: (error: string, result: string) => void);
}
